            ...
            try {
                ...
                if (profile == null) {
                    _uiState.update {
                        it.copy(
                            isProcessing = false,
                            outcome = ScanOutcomeUi.Error(context.getString(R.string.registration_scan_player_not_found)),
                        )
                    }
                    return@launch
                }
                ...
                _uiState.update {
                    it.copy(isProcessing = false, outcome = ScanOutcomeUi.Error(context.getString(R.string.common_error_generic)))
                }
            }
        }
    }
